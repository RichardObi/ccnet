...
seed=42
run_dir="CTRL_CCNET_ANY_ACQ_FT_v0"
...
stage1_uri=""
checkpoint_name="project/outputs/runs/CTRL_CCNET_ANY_ACQ_FT_v0/controlnet_best_val_loss_009079588775546808_epoch80.pth"
...
scale_factor=0.1  #0.01 #=0.3
batch_size=12 #4 #2 #8 #16 #384 #8 #16 #64 #256 #512
n_epochs=100 #150
eval_freq=1
num_workers=8 #16 #64
experiment=${run_dir}
