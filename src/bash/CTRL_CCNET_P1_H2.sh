...
ddpm_uri="project/outputs/runs/LDM_CCNET_P1_ACQ_TXT_v6/ldm_final_model_val_loss_0008376521136295173_epoch100.pth"
stage1_uri=""
...
scale_factor=0.01  #0.01 #=0.3
batch_size=2 #4 #2 #8 #16 #384 #8 #16 #64 #256 #512
n_epochs=100 #150
eval_freq=1
num_workers=4 #16 #64
experiment=${run_dir}
...
controlnet_conditioning_scale=2.5 # 1.0 TODO what will happen if changed?
