...
experiment="INF_CTRL_CCNET_ANY_ACQ_TXT_FT_v1"
...
output_dir="project/outputs/inference/${experiment}/actually_ddim/gs1_cgs1p0_200steps/"
ddpm_uri="project/outputs/runs/LDM_CCNET_ANY_ACQ_TXT_FT_v0/diffusion_best_model.pth"
controlnet_uri="project/outputs/runs/CTRL_CCNET_ANY_ACQ_TXT_FT_v0/controlnet_best_model.pth" #controlnet_best_val_loss_007992724368850848_epoch99.pth"
stage1_uri=""
