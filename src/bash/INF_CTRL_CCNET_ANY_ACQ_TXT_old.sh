...
experiment="INF_CTRL_CCNET_ANY_ACQ_TXT_v0"
guidance_scale=1.0 #0.01 # TODO: test different text-guidance scales here
...
output_dir="project/outputs/inference/${experiment}/ddim/gs1_cgs1_200steps/"
ddpm_uri="project/outputs/runs/LDM_CCNET_ANY_ACQ_TXT_v17/ldm_final_model_val_loss_06331433683314406_epoch100.pth"
controlnet_uri="project/outputs/runs/CTRL_CCNET_ANY_ACQ_TXT_v0/controlnet_best_val_loss_008037116141761028_epoch49.pth"
stage1_uri=""
...
guidance_scale=0.5 #0.01 # TODO: test different text-guidance scales here
#scheduler_type=ddim  #ddpm #ddpm #ddpm #ddim # TODO: test different schedulers here # See https://huggingface.co/docs/diffusers/en/api/schedulers/ddim#tips
#controlnet_conditioning_scale=1.0 #0.8 #1.4 #1.0 # TODO: test different controlnet scales here
output_dir="project/outputs/inference/${experiment}/ddim/gs05_cgs1_200steps/"
...
output_dir="project/outputs/inference/${experiment}/ddim/gs05_cgs1p4_200steps/"
...
#scheduler_type=ddim  #ddpm #ddpm #ddpm #ddim # TODO: test different schedulers here # See https://huggingface.co/docs/diffusers/en/api/schedulers/ddim#tips
controlnet_conditioning_scale=1.4 #0.8 #1.4 #1.0 # TODO: test different controlnet scales here
output_dir="project/outputs/inference/${experiment}/ddim/gs1_cgs1p4_200steps/"
...
output_dir="project/outputs/inference/${experiment}/ddim/gs1_cgs1p6_200steps/"
...
guidance_scale=2.0 #0.01 # TODO: test different text-guidance scales here
#scheduler_type=ddim  #ddpm #ddpm #ddpm #ddim # TODO: test different schedulers here # See https://huggingface.co/docs/diffusers/en/api/schedulers/ddim#tips
controlnet_conditioning_scale=1.4 #0.8 #1.4 #1.0 # TODO: test different controlnet scales here
output_dir="project/outputs/inference/${experiment}/ddim/gs2_cgs1p4_200steps/"
...
guidance_scale=7.0 #0.01 # TODO: test different text-guidance scales here
#scheduler_type=ddim  #ddpm #ddpm #ddpm #ddim # TODO: test different schedulers here # See https://huggingface.co/docs/diffusers/en/api/schedulers/ddim#tips
controlnet_conditioning_scale=1.4 #0.8 #1.4 #1.0 # TODO: test different controlnet scales here
output_dir="project/outputs/inference/${experiment}/ddim/gs7_cgs1p4_200steps/"
