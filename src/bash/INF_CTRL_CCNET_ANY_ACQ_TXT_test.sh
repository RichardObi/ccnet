...
output_dir="project/outputs/inference/${experiment}/actually_ddim/gs1_cgs1p6_200steps/"
...
output_dir="project/outputs/inference/${experiment}/actually_ddim/gs1_cgs1p8_200steps/"
...
output_dir="project/outputs/inference/${experiment}/actually_ddim/gs0p5_cgs1_200steps/"
...
output_dir="project/outputs/inference/${experiment}/actually_ddim/gs1_cgs1p4_200steps/"
...
guidance_scale=1.0 #0.01 # TODO: test different text-guidance scales here
#scheduler_type=ddim  #ddpm #ddpm #ddpm #ddim # TODO: test different schedulers here # See https://huggingface.co/docs/diffusers/en/api/schedulers/ddim#tips
controlnet_conditioning_scale=2.0 #0.8 #1.4 #1.0 # TODO: test different controlnet scales here
output_dir="project/outputs/inference/${experiment}/actually_ddim/gs1_cgs2_200steps/"
