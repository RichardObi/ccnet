...
y_size=64 #28 # 64 #28 # 64 #28 #64 #20 # size of noise embedding, e.g. noisy_e shape: torch.Size([3, 4, 64, 64])
x_size=64 #28 # 64 #28 #64 #28 #64 #28
experiment="INF_CTRL_CCNET_P1_v0"
guidance_scale=0.0 #0.01 # TODO: test different text-guidance scales here
...
output_dir="project/outputs/inference/${experiment}/actually_ddim/gs0_cgs1p4_200steps_2/"
ddpm_uri="project/outputs/runs/LDM_CCNET_P1_v0/ldm_final_model_val_loss_0008376521136295173_epoch100.pth"
controlnet_uri="project/outputs/runs/CTRL_CCNET_P1_v0/controlnet_best_val_loss_00016750191936578539_epoch64.pth" #controlnet_best_val_loss_008037116141761028_epoch49.pth"
stage1_uri=""
test_ids="project/outputs/ids/p1/test.tsv"
config_file="configs/controlnet/controlnet_v1.yaml"
scale_factor=0.01 #0.18215 #0.1  #0.01 #=0.3
...
img_width=512 #224 #512
img_height=512 #224 #512
