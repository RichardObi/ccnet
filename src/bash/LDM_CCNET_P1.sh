...
seed=42
run_dir="LDM_CCNET_P1_v3_last" #"LDM_CCNET_P1_ACQ_TXT_v6" changed on 23.02.2024
stage1_uri=""
...
scale_factor=0.005 #0.01 #8 #0.3
batch_size=12 #32 #8 #16 #64 #256 #512
n_epochs=100
adv_start=10
eval_freq=1
num_workers=8 #163
