...
checkpoint_name="ldm_val_loss_0008223428780058212_epoch50.pth" #"project/outputs/runs/LDM_CCNET_P1_ACQ_TXT_v0/ldm_val_loss_0008223428780058212_epoch50.pth"
seed=42
run_dir="LDM_CCNET_P1_ACQ_TXT_v0" #"LDM_CCNET_P1_ACQ_TXT_v6" changed on 23.02.2024
stage1_uri=""
...
batch_size=16 #8 #32 #8 #16 #64 #256 #512
n_epochs=100
adv_start=10
eval_freq=1
num_workers=8 #163
