...
checkpoint_name="ldm_val_loss_000846921493543658_epoch80.pth"  #"project/outputs/runs/LDM_CCNET_P1_TXT_v0/ldm_val_loss_000846921493543658_epoch80.pth"

seed=42
run_dir="LDM_CCNET_P1_TXT_v0" #"LDM_CCNET_P1_ACQ_TXT_v6" changed on 23.02.2024
stage1_uri=""
