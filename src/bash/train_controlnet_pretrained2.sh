...
seed=42
run_dir="aekl_v0_ldm_v0_controlnet_v0_pretrained2"
...
ddpm_uri="project/outputs/checkpoints/diffusion_best_model.pth"
stage1_uri=""
...
batch_size=8 #384 #8 #16 #64 #256 #512
n_epochs=150
eval_freq=5
num_workers=4 #16 #64
experiment="CONTROLNET_v1_08122023_pretrained2"
is_resumed=true #false #true
use_pretrained=2 # loading both the VAE AND also the LDM as pretrained models (from source_model)
