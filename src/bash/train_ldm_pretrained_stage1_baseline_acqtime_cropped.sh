...
root_path="/home/richard/Desktop/software/data/ldm_data_all_phases_cropped"
...
config_file="configs/ldm/ldm_v4.yaml"
scale_factor=0.01 #0.1 #0.01 #8 #0.3
batch_size=16 #16 #32 #8 #16 #64 #256 #512
n_epochs=100
adv_start=10
eval_freq=1
num_workers=4 #163
...
clip_grad_norm_or_value='norm' #'value'
img_width=224
img_height=224
