...
def convert_and_save(patient):
    input_folder_path = '/home/roo/data/RadioVal/richard/manifest-1686223866660/Duke-Breast-Cancer-MRI'  # '/home/roo/data/RadioVal/richard/Duke-Breast-Cancer-MRI'
    output_folder_path = '/home/roo/data/RadioVal/richard/manifest-1686223866660/Duke-Breast-Cancer-MRI-Nifti-Whole'
...
with open(
        '/home/roo/data/RadioVal/richard/manifest-1686223866660/Duke_Breast_MRI_all_phases_without_masks.csv') as file_obj:
    phases_failed_to_convert = 0
