...
base_path = '/Users/richardosuala/Desktop'
...
new_data = []
# iterating over all patient_ids in first column of xlsx file

# get the row of the first patient_id
...
df.to_csv(f'{base_path}/LDM_metadata.csv', index=False, sep=';')
