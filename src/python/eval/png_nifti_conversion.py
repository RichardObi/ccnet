...
### Local
#PREFIX_PATH = os.path.join('/Users/richardosuala/Desktop/Radioval_data_test/', '')
#PREFIX_OUTPUT_PATH = PREFIX_PATH


### Server
PREFIX_PATH = os.path.join('/home/roo/data/RadioVal/riti/Radioval_data/')
#PREFIX_OUTPUT_PATH = os.path.join('/home/roo/Desktop/software/breastmri/data/synthetic_nifti', '')  # PREFIX_PATH
#PREFIX_OUTPUT_PATH = PREFIX_PATH

INPUT_FOLDER_PATH_NIFTI = os.path.join(PREFIX_PATH, 'Duke-Breast-Cancer-MRI-Nifti-Whole')
INPUT_FOLDER_PATH_2DSLICES = os.path.join(f'/home/roo/Desktop/software/breastmri/src/synthesis/pix2pixHD/results/pre2postcontrast_512p_train_1to195/test_{CHECKPOINT}/only_synthetic/', '')
#INPUT_FOLDER_PATH_2DSLICES = os.path.join(PREFIX_PATH, 'Duke-Breast-Cancer-MRI-png-Whole')
    ...
    if TRANSFORM_TO_GRAYSCALE or ADJUST_ASPECT_RATIOS_TO_ORIGINAL_NIFTI:
        for idx, file_name in enumerate(file_names):
            ...
            if ADJUST_ASPECT_RATIOS_TO_ORIGINAL_NIFTI:
                ...
                # assumption 2: We arte using axial slides, so we only need to adjust the first two dimensions
