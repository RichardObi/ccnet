...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output_folder",
        type=str,
        default="/home/roo/data/RadioVal/richard/train_test/test/subtraction_real",
    ...
    parser.add_argument(
        ...
        help="If only specific cases in folder should be translated. Note: Specific naming convention needed - see below in code. name of cases can include folder path prefix",
    )
    parser.add_argument(
